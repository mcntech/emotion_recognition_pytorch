...
EMOTION_COLOR_MAP = {'angry': RED, 'smile': GREEN,
                     'surprised': BLUE, 'neutral': PURPLE, 'sad': GRAY}
...
def process_image(face_images, boxes, predict, draw, font=None, font_loader=None, padding=5, line_width=3):
    ...
    for face_img, box in zip(face_images, boxes):
        ...
        draw.rectangle((x_min, y_min, x_min + text_width + padding,
                        y_min + text_height + padding), fill=color)
...
if __name__ == '__main__':
    ...
    pil_img = Image.open(
        '/home/gp/Documents/projects/facial_emotion_detection/data/test/img/portrait-asian-male-driver-mad-260nw-1374785156.jpg').convert('RGB')
