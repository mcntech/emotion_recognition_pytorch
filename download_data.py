...
def download_emotions(emotion_map, data_dir, driver_dir, emotion_limit=2000, synonym_limit=1000):
    ...
    for emotion_label, keywords in emotion_map.items():
        for k in keywords:
            ...
            args.update({'keywords': construct_query(
                k), 'image_directory': emotion_label, 'limit': search_limit})
...
if __name__ == '__main__':
    chrome_driver = '/home/gp/Documents/projects/facial_emotion_detection/data'

    # download the emotion data
    data_dir = '/home/gp//Documents/projects/facial_emotion_detection/data$/data/imagenet/'
    emotions = {'angry': ['angry', 'furious', 'resentful', 'irate'],
                'neutral': ['disgusted', 'sour', 'grossed out'],
                'happy': ['happy', 'smiling', 'cheerful', 'elated', 'joyful'],
                'sad': ['sad', 'depressed', 'sorrowful', 'mournful', 'grieving', 'crying'],
                'surprised': ['neutral', 'impartial', 'unbiased', 'umemotional']}
    download_emotions(emotions, data_dir, chrome_driver)

    # download the pseudo Imagenet data
    imagenet_labels = []
    with open('/home/gp/Documents/projects/facial_emotion_detection/data/train/imagenet_labels.txt', 'r') as file:
        for line in file:
            imagenet_labels.append(line.strip())
    data_dir = '/home/gp//Documents/projects/facial_emotion_detection/data/imagenet/'
    imagenet_label_file = '/home/gp//Documents/projects/facial_emotion_detection/data/imagenet_labels.txt'
